...
export const BRAIN_WRITE_TOOLS: BrainToolSpec[] = [
  ...
  {
    name: "create_employee_shift",
    description: "Schedule an employee shift without requiring a customer",
    permissionLevel: "write",
    requiresConfirmation: true,
    inputFields: [
      "employee_ids[]",
    ...
    actionType: "create_employee_shift",
    auditEvent: "brain.write.create_employee_shift",
  },
  {
    name: "create_internal_schedule_entry",
    description: "Schedule internal work, meetings, training, or maintenance",
    permissionLevel: "write",
    requiresConfirmation: true,
    inputFields: [
      "employee_ids[]",
    ...
    actionType: "create_internal_schedule_entry",
    auditEvent: "brain.write.create_internal_schedule_entry",
  },
  {
    name: "create_time_off",
    description: "Schedule employee time off such as vacation or sick time",
    permissionLevel: "write",
    requiresConfirmation: true,
    inputFields: [
      "employee_ids[]",
    ...
    auditEvent: "brain.write.create_time_off",
  },
  {
    name: "create_multi_day_assignment",
    description: "Assign employees to multi-day work with optional customer or site",
    permissionLevel: "write",
    requiresConfirmation: true,
    inputFields: [
      "employee_ids[]",
    ...
    auditEvent: "brain.write.create_multi_day_assignment",
  },
];
